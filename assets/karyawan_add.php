            ...
            <div id="layoutSidenav_content">
                <main>
                    ...
                    <div class="page-header mb-4">
                        ...
                        <div class="col-sm-9">
                          <select class="form-control" name="lokasi" required="">'<option value="Asep Barbershop">Asep Barbershop</option></select>  
                        </div>
                      </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                <input type="text" class="form-control" name="notelpkar" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    Laki-laki:
                                    <input type="radio" class="flat" name="jkkar" value="Laki-laki" checked=""> 
                                    Perempuan:
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                <textarea class="resizable_textarea form-control" name="alamatkar"></textarea>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="exampleInputUsername2" class="col-sm-3 mb-2 col-form-label">Username</label>
                                <div class="col-sm-9">
                                <input type="text" class="form-control" name="usernamekar" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="exampleInputUsername2" class="col-sm-3 mb-2 col-form-label">Password</label>
                                <div class="col-sm-9">
                                <input type="password" class="form-control" name="passwordkar" required>
                                </div>
                            </div>                       
                            <br>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9"> 
                                <button type="submit" name="tambahkaryawan" class="btn btn-outline-success mr-2">Simpan</button>
                                <button type="button" class="btn btn-outline-danger mr-2" data-dismiss="modal">Tutup</button>
                                </div>
                            </div>
                            </form> 
                        </div>
